...
inline fun <Token, R> seq(vararg parsers: Parser<Token, out R>) = combi<Token, List<R>>("{error}") {
    parsers.map { it.bind() }
}

inline fun <R1, R2, R, Token> seq(p1: Parser<Token, R1>, p2: Parser<Token, R2>, crossinline map: (v1: R1, v2: R2) -> R) =
    combi<Token, R> { map(p1.bind(), p2.bind()) }
...
inline fun <Token, R> seq(p1: LiteralParser<Token>, p2: Parser<Token, R>) =
    combi<Token, R> {
        p1.bind()
        p2.bind()
    }

inline fun <Token, R> seq(p1: Parser<Token, R>, p2: LiteralParser<Token>) =
    combi<Token, R> {
        val r = p1.bind()
        p2.bind()
        r
...
inline fun <Token, R1, R2> seq(p1: Parser<Token, R1>, p2: Parser<Token, R2>) = seq(p1, p2, ::Pair)
...
inline fun <R1, R2, R3, R, Token> seq(p1: Parser<Token, R1>, p2: Parser<Token, R2>, p3: Parser<Token, R3>,
    ...
    combi<Token, R> { map(p1.bind(), p2.bind(), p3.bind()) }
...
inline fun <R1, R2, R3, R4, R, Token> seq(p1: Parser<Token, R1>, p2: Parser<Token, R2>,
    ...
    combi<Token, R> { map(p1.bind(), p2.bind(), p3.bind(), p4.bind()) }
...
inline fun <R1, R2, R3, R4, R5, R, Token> seq(p1: Parser<Token, R1>, p2: Parser<Token, R2>,
    ...
    combi<Token, R> { map(p1.bind(), p2.bind(), p3.bind(), p4.bind(), p5.bind()) }
...
inline fun <R1, R2, R3, R4, R5, R6, R, Token> seq(p1: Parser<Token, R1>, p2: Parser<Token, R2>,
    ...
    combi<Token, R> { map(p1.bind(), p2.bind(), p3.bind(), p4.bind(), p5.bind(), p6.bind()) }

//infix fun <Token, R> Parser<Token, R>.and(other: Parser<Token, R>) = seq(this, other)
infix fun <Token, R> LiteralParser<Token>.and(other: Parser<Token, R>) = seq(this, other) { _, r -> r }
infix fun <Token, R> Parser<Token, R>.and(other: LiteralParser<Token>) = seq(this, other) { r, _ -> r }
infix fun <Token> LiteralParser<Token>.and(other: LiteralParser<Token>) = seq(this, other)
infix fun <Token, R1, R2> Parser<Token, R1>.and(other: Parser<Token, R2>) = seq(this, other)
