...
class SeqTest {
    ...
    fun `sequence of two as pair`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe ("a" to "1")
    }
    ...
    fun `sequence of two`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe listOf("a", "1")
    }
    ...
    fun `sequence of three`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe listOf("a", "1", "b")
    }
    ...
    fun `sequence of four`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe listOf("a", "1", "b", "2")
    }
    ...
    fun `sequence of five`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe listOf("a", "1", "b", "2", "c")
    }
    ...
    fun `sequence of six`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe listOf("a", "1", "b", "2", "c", "3")
    }
    ...
    fun `sequence of six failing`() {
        ...
        shouldThrowMessage<ParseException>("Combinator failed, parser number 4 with error: Character c is not a digit") {
            parser(CharSequenceContext("a1bc3d4"))
    ...
    fun `varargs long sequence`() {
        ...
        parser(CharSequenceContext("a1b2c3d4")) shouldBe listOf("a", "1", "b", "2", "c", "3", "d", "4")
    }
